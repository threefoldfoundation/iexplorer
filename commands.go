...
// Root represents the root (`iexplorer`) command,
// starting a iexplorer daemon instance, running until the user intervenes.
func (cmd *Commands) Root(_ *cobra.Command, args []string) (cmdErr error) {
	log.Println("starting iexplorer v" + version.String() + "...")
	...
	go func() {
		...
		log.Println("iexplorer is up and running...")
...
// Version represents the version (`iexplorer version`) command,
